...
def language_selected(request):
    ...
    return render(request, 'language_selected.html',
                  {'news': top_news['articles'], 'status_check': print('check.status'), 'sources': print('sources'),
                   'categories': print('categories'), 'languages': print('languages'), 'check_status': print('check.status'),
                   'language_news': print('language_selected_news'), 'selected_language': request.GET['language_id']})
